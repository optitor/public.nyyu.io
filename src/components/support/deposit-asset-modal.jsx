...
export default function DepositAssetModal({ isOpen, setIsOpen }) {
                    ...
                    <form action="form">
                        ...
                        <div className="form-group">
                            <FormInput
                                ...
                                placeholder="Enter your deposit receiving address"
                                value={payload.receiverAddr || ''}
                                onChange={e => {
                                    setPayload({...payload, receiverAddr: e.target.value})
                                }}
                            />
                        </div>
                        <div className="form-group">

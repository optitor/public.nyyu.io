...
const ConfirmModal = ({isModalOpen, setIsModalOpen, confirmData = '', doAction, pending = false, title = '', desc = ''}) => {
        ...
        >
            ...
            <DeleteConfirm>
                <div className='text-center'>
                    <p>{title? title: `Are you sure you want to delete?`}</p>

...
import { update_Avatar_Component } from "../../../redux/actions/avatarAction";
...
const EditAvatarComponentModal = ({isModalOpen, setIsModalOpen, datum ={}}) => {
    ...
    // Avatar
    const [category, setCategory] = useState(categories.filter(item => item.value === datum.groupId)[0]);
    ...
    // Price Data
    const initialPriceData = { price: datum.price, limitation: datum.limited, tier: {} };
    ...
    const handleSubmit = async () => {
        setPending(true);
        await dispatch(update_Avatar_Component({

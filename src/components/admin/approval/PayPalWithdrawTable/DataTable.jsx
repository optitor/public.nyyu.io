...
import PaypalWithdrawDataRow from './PaypalWithdrawDataRow';
...
const RoundsTable = () => {
    ...
    useQuery(Query.GET_ALL_PAYPAL_WITHDRAWS, {
        onCompleted: data => {
            if(data.getAllPaypalWithdraws) {
                paypalWithdraw.fetchData(data.getAllPaypalWithdraws);
            }
            setLoading(false);
        },
        onError: err => {
                    ...
                    {_.isEmpty(showData)?
                        ...
                        (
                            <>
                                <TableBody>
                                    {pageData.map(datum => {
                                        return <PaypalWithdrawDataRow key={datum.id} datum={datum} />
                                    })}
                                </TableBody>

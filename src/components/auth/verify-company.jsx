                    ...
                    <div className="container verify-company_container">
                        <div className="header">
                            <h4 className="text-center mt-2 mb-4">
                                {language?.content?.verify_company}
                            </h4>
                            {step !== -1 && step <= 2 && (
                        ...
                        {step === 1 && (
                            <div className="verify-step2">
                                <p className="text-center my-4">
                                    For Directors and shareholders owning more
                                    that 25% of the business please verify
                                </p>
                                {verifiers.map((row, i) => (
                        ...
                        {step === 2 && (
                            <div className="verify-step3">
                                <p className="text-center my-4 verify-step3_title">
                                    Thank you, {business_name} have been
                                    successfully verified.
                                </p>
                                <span>
                                    As soley the data processor, NDB
                                    acknowledges your right to request access,
                                    erasure, and retention of your data. Contact
                                    out Data Compliance Officer at
                                </span>

...
const IndexPage = () => {
    ...
    const sendToError = useMemo(() => {
        if (!sendTo.userGroup.value)
            return { userGroup: "User Group is required" };
        return {};
    }, [sendTo]);
            ...
            <main className="create-email-page">
                <LayoutForCreate>
                    ...
                    <Stepper2
                        ...
                        texts={["New Email", "Send to"]}
                    />
                    {currentStep === 1 && (
                        <>
                            <div className="input_div">
                                {showError ? (
                                    Object.values(emailError)[0] ? (
                                ...
                                <div className="div1">
                                    <div>
                                        <p>Email Name</p>
                                        <input
                                            className={`black_input ${showError && emailError.name ? "error" : ""}`}
                                            value={email.name}
                                            onChange={(e) =>
                                                setEmail({
                                                    ...email,
                                    ...
                                    <div>
                                        <p>Email Subject</p>
                                        <input
                                            className={`black_input ${showError && emailError.subject ? "error" : ""}`}
                                            value={email.subject}
                                            onChange={(e) =>
                                                setEmail({
                                                    ...email,
                                ...
                                <div className="div2 mt-4">
                                    <p>Email Content</p>
                                    <textarea
                                        className={`black_input ${showError && emailError.content ? "error" : ""}`}
                                        rows={3}
                                        value={email.content}
                                        onChange={(e) =>
                                            setEmail({
                                    ...
                                    <div className="mt-4">
                                        ...
                                        >
                                            <div className="date_picker">
                                                <p
                                                    className={`${showError && sendToError.time ? "error" : ""}`}
                                                >

...
export const SIGNUP = gql`
    mutation signup($email: String!, $password: String!, $country: String!, $referredByCode: String) {
        signup(email: $email, password: $password, country: $country, referredByCode: $referredByCode)
    }
`
